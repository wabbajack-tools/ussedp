...
dotnet run --project MakeSelfContained c:\tmp\Patcher\Patcher.exe c:\tmp\uploadBestOfBoth\patch c:\tmp\finalUpload\BestOfBothPatcher.exe
dotnet run --project MakeSelfContained c:\tmp\Patcher\Patcher.exe c:\tmp\upload\patch c:\tmp\finalUpload\FullPatcher.exe
"C:\Program Files (x86)\Windows Kits\10\bin\10.0.19041.0\x64\signtool.exe" sign /t http://timestamp.sectigo.com c:\tmp\finalUpload\BestOfBothPatcher.exe
